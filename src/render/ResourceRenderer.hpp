...
namespace game::render
{
    class ResourceRenderer final
    {
      public:
        ...
        void draw_ores(const sf::View& view, const terrain::PlanetTerrain& terrain, const resources::ResourceSystem& resources);

      private:
        Result<void> rebuild_ore_instances(const terrain::PlanetTerrain& terrain, const resources::ResourceSystem& resources);
