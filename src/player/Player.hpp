...
namespace game::player
{
    ...
    class Player final
    {
      public:
        ...
        void prepare_for_physics_step(float fixed_step, vec2 planet_center, bool in_water, const platform::InputSystem& input);
        ...
        bool is_in_water() const noexcept
        {
            return in_water_;
        }
        void set_in_water(bool in_water) noexcept
        {
            in_water_ = in_water;
        }
      ...
      private:
        ...
        void apply_horizontal_movement(float fixed_step, vec2 movement_direction, bool in_water, const platform::InputSystem& input);
