...
namespace game::terrain
{
    ...
    {
        bool is_surface_exposed_world(const TerrainSurfaceFieldView& view, vec2 world_position, float clearance_distance);
        std::optional<TerrainSurfaceAttachment> exposed_surface_attachment(const TerrainSurfaceFieldView& view, ivec2 coord);
        std::optional<vec2> surface_anchor_world(const TerrainSurfaceFieldView& view, ivec2 coord);
    }
}
