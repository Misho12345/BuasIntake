...
namespace game::terrain
{
    ...
    public:
        ...
        const FieldSample& global_sample(ivec2 coord) const { return global_field_[global_field_index(coord)]; }
        uvec2 global_field_size() const { return global_field_size_; }
        ...
        const vegetation::VegetationSystem& vegetation_system() const { return *vegetation_; }
        bool contains_water_volume(vec2 world_position) const;
        resources::ResourceSystem& resource_system() { return *resources_; }
        const resources::ResourceSystem& resource_system() const { return *resources_; }
    ...
    private:
        ...
        // these two passes are split because geometry needs to react quickly but wetness and greenness can wait a little and batch together
