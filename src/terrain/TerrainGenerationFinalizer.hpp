...
namespace game::terrain
{
    ...
    {
        std::vector<ivec2> initialize_visual_channels_and_smooth_caves(TerrainGenerationFieldView view,
                                                                       const TerrainGenerationCallbacks& callbacks);
        void generate_resource_nodes(const TerrainGenerationFieldView& view, const TerrainGenerationCallbacks& callbacks);
    }
}
